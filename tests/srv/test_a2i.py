...
def test():
    ...
    assert console.a2i.to_human_review_workflow_arn(flow_name) == flow_arn
    assert console.a2i.to_human_review_workflow_name(flow_arn) == flow_name
    ...
    assert console.a2i.to_worker_task_template_arn(task_template_name) == task_template_arn
    assert console.a2i.to_worker_task_template_name(task_template_arn) == task_template_name
    ...
    assert console.a2i.to_human_loop_arn(human_loop_name) == human_loop_arn
    assert console.a2i.to_human_loop_name(human_loop_arn) == human_loop_name
